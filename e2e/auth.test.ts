...
import type { Tokens } from "../src/lib/server/utils/supertokens/cookieHelpers";
    ...
    it.describe("Session Refreshing", () => {
      ...
      it.describe("Automatic Session Refreshing", () => {
        it("Refreshes the user's session while they interact with secure routes", async ({
          ...
          it.skip(javaScriptEnabled, "Not yet testable with JS. See: https://github.com/sveltejs/kit/issues/10855");
